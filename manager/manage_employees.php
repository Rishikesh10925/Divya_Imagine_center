...
// Fetch users for the table (excluding superadmin for managers)
$users_result = $conn->query("SELECT id, username, role, is_active, created_at FROM users WHERE role != 'superadmin' ORDER BY username ASC");
